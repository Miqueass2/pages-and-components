...
var _index1 = require("../components/title/index");
var _index2 = require("../components/text-lorem/index");
var _index3 = require("../components/subtitle/index");
var _index4 = require("../components/label-input/index");
var _index5 = require("../components/button/index");
var _index6 = require("../components/footer/index");
var _index7 = require("../components/button-step/index");
var _index8 = require("../components/button-back/index");
(function() {
    (0, _index.header)();
    (0, _index1.title)();
    (0, _index2.textLorem)();
    (0, _index3.subtitle)();
    (0, _index4.labelAndInput)();
    (0, _index5.button)();
    (0, _index6.footer)();
    (0, _index7.butonStepOne)();
    (0, _index8.buttonVolver)();
    const rootEl = document.querySelector(".root");
    (0, _router.initRouter)(rootEl);
})();

},{"./router":"4QFWt","../components/header/index":"bM2g5","../components/title/index":"3pUEU","../components/text-lorem/index":"6WZS1","../components/subtitle/index":"cRgpS","../components/label-input/index":"ahywp","../components/button/index":"4iqCu","../components/footer/index":"aKPlg","../components/button-step/index":"i9yUT","../components/button-back/index":"dAdto"}],"4QFWt":[function(require,module,exports) {
...
const routes = [
    {
        path: /\/welcome/,
        component: (0, _welcome.initPageA)
    },
    {
        path: /\/step-1/,
        component: (0, _step1.initPageB)
    },
    {
        path: /\/thankyou/,
...
function initRouter(container) {
    ...
    function handleRoute(route) {
        ...
        for (const r of routes)if (r.path.test(route)) {
            ...
            if (container?.firstChild) // SI CONTAINER TIENE UN FIRST CHILD LO SACO , Y AGREGO CON APPENDCHILD EL COMPONENT SEGUN LA RUTA
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3pUEU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
        ...
        render() {
         ...
         `;
            ...
            if (location.pathname === "/welcome") {
                let titleName = "Te damos la bienvenida a esta p\xe1gina";
            ...
            .title{
               ...
               width:282px
                ...
                let titleName1 = "Necesitamos algunos datos m\xe1s";
                div.textContent = `${titleName1}`;
            } else if (location.pathname === "/thankyou") {
                let titleName2 = "Gracias";
                div.textContent = `${titleName2}`;
            }
            shadow.appendChild(style);
            shadow.appendChild(div);
        }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6WZS1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "textLorem", ()=>textLorem);
function textLorem() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cRgpS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    class Subtitle extends HTMLElement {
        ...
        render() {
         ...
         `;
            ...
            let subtitleContent = "Para continuar ingres\xe1 tu nombre";
            ...
            `;
                let subtitleContent1 = "Toda la informaci\xf3n que nos brindaste es muy importante";
                divSubtitle.textContent = `${subtitleContent1}`;
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ahywp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "labelAndInput", ()=>labelAndInput);
        ...
        render() {
         ...
         `;
            ...
            if (location.pathname === "/welcome") {
                ...
                let placeHolderText = "Ingres\xe1 tu nombre";
                divInput.innerHTML = `
            <input class="input" type="text" placeholder="${placeHolderText}">
            `;
                divInputTwo.style.display = "none";
            } else if (location.pathname === "/step-1") {
                let labelContent1 = "Email";
                divLabel.textContent = `${labelContent1}`;
                let placeHolderText1 = "";
                divInput.innerHTML = `
            <input class="input" type="text" placeholder="${placeHolderText1}">
            `;
         ...
         `;
            if (location.pathname === "/step-1") {
               ...
               border-radius:4px
                ...
                let buttonContent1 = "Continuar";
                divButton.innerHTML = `
            <button class="button">${buttonContent1}</button>
            `;
            } else if (location.pathname === "/thankyou") {
                style.textContent = `.button{
               width:312px;
               ...
               border-radius:4px
                ...
                let buttonContent2 = "De nada";
                divButton.innerHTML = `
            <button class="button">${buttonContent2}</button>
            `;
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i9yUT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "butonStepOne", ()=>butonStepOne);
function butonStepOne() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dAdto":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
